 ...
 * the 'images' class, and resolve the promise.
 ...
 * (HINT: Use the image element returned by the createImage promise to hide the
 ...
 * wrong image path. Set the network speed to 'Fast 3G' in the dev tools Network tab,
...
createImage('img/img-10.jpg').catch(err => {
  console.log(err);
});
