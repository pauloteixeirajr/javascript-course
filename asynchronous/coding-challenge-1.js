 ...
 * Coding Challenge #1
 *
 * In this challenge you will build a function 'whereAmI' which renders a country ONLY based
 * on GPS coordinates. For that, you will use a second API to geocode coordinates.
 * Here are your tasks:
 *
 * PART 1
 ...
 * coordinates to a meaningful location, like a city and country name.
 ...
 * So take the relevant attribute from the geocoding API result, and plug it into the
