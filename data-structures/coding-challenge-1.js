...
// In this challenge we're going to work with the data.
...
// 2. The first player in any player array is the goalkeeper and the other are field players.
// For Bayern (team 1) create one variable ('gk') with the goalkeeper's name, and one array ('fieldPlayers')
...
const playes1Final = [...players1, 'Thiago', 'Coutinho', 'Perisic'];
console.log(playes1Final);

// 5. Based on the game.odds object, create one variable for each odd (called 'team1', 'draw', and 'team2')
const { team1, x: draw, team2 } = game.odds;
console.log(team1, draw, team2);

// 6. Write a function ('printGoals') that recieves an arbitrary number of player names (NOT an array)
// and print each of them to the console, along with the number of goals that were scored in total
